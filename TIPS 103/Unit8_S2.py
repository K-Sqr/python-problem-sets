...
# Note: The term leaf in this problem refers to the plant leaf 🍃 of a Monstera plant, 
# not the type of node leaf nodes which are nodes with no children.
...
"""
U: Count how many odd value nodes ar in the binary tree
P: 
Use recursion
initialize count
if root value is odd, count += 1
